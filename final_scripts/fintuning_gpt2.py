...
from rerankGPT2LMHeadModel import rerankGPT2LMHeadModel_finetuning_gpt2, wiki2021_GPT2Dataset
...
model = rerankGPT2LMHeadModel_finetuning_gpt2.from_pretrained("gpt2", 
                                                              config=configuration,
                                                              MAX_LEN = MAX_LEN,
                                                              CAN_NUM = CAN_NUM, 
                                                              num_of_rerank = num_of_rerank)
# model = rerankGPT2LMHeadModel_stage1_all_tokens_no_stage2.from_pretrained("results/baseline_wiki2021/stage1_all_tokens_no_stage2_canNUM20/last_model", 
#                                                         config=configuration,
#                                                         MAX_LEN = MAX_LEN,
#                                                         CAN_NUM = CAN_NUM, 
#                                                         num_of_rerank = num_of_rerank)
...
for epoch_i in range(0, epochs):
    ...
    for step, batch in enumerate(train_dataloader):  
        ...
        # loss = normal_loss
        loss = normal_loss_in_rerank_place
        ...
        if step % 1000 == 0 and not step == 0:
            ...
            print("batch_normal_loss:", batch_normal_loss, "batch_normal_loss_in_rerank_place:", batch_normal_loss_in_rerank_place)
        ...
        if step % 10000 == 0:           
            ...
            print("  Average inside Validation loss:", avg_val_loss)
            print("  Average inside Validation normal_loss:", avg_val_normal_loss)
            print("  Average inside Validation normal_loss_in_rerank_place:", avg_val_normal_loss_in_rerank_place)
        ...
        if step % 30000 == 0 and not step == 0:
            ...
            model.module.save_pretrained(
                "final_results/can_num20/fintuning_gpt2_lr1e4_bs64_rp20/"+str(step)
            )
...
model.module.save_pretrained("final_results/can_num20/fintuning_gpt2_lr1e5_bs64_rp20/last_model")