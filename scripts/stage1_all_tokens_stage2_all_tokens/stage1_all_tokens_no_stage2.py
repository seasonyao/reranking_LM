...
model = rerankGPT2LMHeadModel_stage1_all_tokens_no_stage2.from_pretrained("gpt2", config=configuration,
                                                        MAX_LEN = MAX_LEN,
                                                        CAN_NUM = CAN_NUM, 
...
#         scheduler.step()
        ...
        if step % 50000 == 0 and not step == 0:
            ...
            model.module.save_pretrained(
                "results/stage1_all_tokens_stage2_all_tokens/lr1e5_bs8_no_stage2/"+str(step)
            )
...
model.module.save_pretrained("results/stage1_all_tokens_stage2_all_tokens/lr1e5_bs8_no_stage2/last_model")