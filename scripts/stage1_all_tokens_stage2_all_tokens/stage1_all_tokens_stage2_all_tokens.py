...
#             print("batch_stage1_rerank_hidden_states_meganitude:", batch_stage1_rerank_hidden_states_meganitude)
        ...
        if step % 50000 == 0 and not step == 0:
            ...
            model.module.save_pretrained(
                "results/stage1_all_tokens_stage2_all_tokens/lr1e5_bs8_replace/"+str(step)
            )
...
model.module.save_pretrained("results/stage1_all_tokens_stage2_all_tokens/lr1e5_bs8_replace/last_model")