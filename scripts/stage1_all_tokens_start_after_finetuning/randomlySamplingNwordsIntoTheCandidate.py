...
from rerankGPT2LMHeadModel import rerankGPT2LMHeadModel_randomlySamplingNwordsIntoTheCandidate, wiki2021_GPT2Dataset
...
model = rerankGPT2LMHeadModel_randomlySamplingNwordsIntoTheCandidate.from_pretrained("/mnt/nfs/work1/llcao/zhiyilai/reranking_LM/results/baseline_wiki2021/stage1_all_tokens_no_stage2_canNUM20/last_model",
...
#----------------------------------------------------------------------------------------
with open('/mnt/nfs/work1/llcao/zonghaiyao/LM/data/wiki2021/wiki2021_5to8_train_dataset.pkl', 'rb') as f:
    train_input_ids = pickle.load(f)
with open('/mnt/nfs/work1/llcao/zonghaiyao/LM/data/wiki2021/wiki2021_0to4_validation_dataset.pkl', 'rb') as f:
    validation_input_ids = pickle.load(f)
with open('/mnt/nfs/work1/llcao/zonghaiyao/LM/data/wiki2021/wiki2021_0to4_inside_validation_dataset.pkl', 'rb') as f:
...
for epoch_i in range(0, epochs):
    ...
    for step, batch in enumerate(train_dataloader): 
        ...
        if step % 10000 == 0 and not step == 0:
            ...
            model.module.save_pretrained(
                "results/stage1_all_tokens_start_after_finetuning/randomlySamplingNwordsIntoTheCandidate/"+str(step)
            )
    ...
    print("  Average training stage1_loss_in_rerank_place_across_candidates:", avg_train_stage1_loss_in_rerank_place_across_candidates)
...
model.module.save_pretrained("results/stage1_all_tokens_start_after_finetuning/randomlySamplingNwordsIntoTheCandidate/last_model")