...
from rerankGPT2LMHeadModel import rerankGPT2LMHeadModel_labelInCandidateWhenTraning, wiki2021_GPT2Dataset
...
model = rerankGPT2LMHeadModel_labelInCandidateWhenTraning.from_pretrained("/mnt/nfs/work1/llcao/zhiyilai/reranking_LM/results/baseline_wiki2021/stage1_all_tokens_no_stage2_canNUM20/last_model",
    ...
    for step, batch in enumerate(train_dataloader): 
        ...
        if step % 10000 == 0 and not step == 0:
            ...
            model.module.save_pretrained(
                "results/stage1_all_tokens_start_after_finetuning/labelInCandidateWhenTraning/"+str(step)
            )
...
model.module.save_pretrained("results/stage1_all_tokens_start_after_finetuning/labelInCandidateWhenTraning/last_model")