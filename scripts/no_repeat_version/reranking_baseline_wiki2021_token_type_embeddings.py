...
from rerankGPT2LMHeadModel import rerankGPT2LMHeadModel_token_type_embeddings, wiki2021_GPT2Dataset
...
model = rerankGPT2LMHeadModel_token_type_embeddings.from_pretrained("gpt2", config=configuration,
                                                                    MAX_LEN = MAX_LEN,
                                                                    CAN_NUM = CAN_NUM, 
