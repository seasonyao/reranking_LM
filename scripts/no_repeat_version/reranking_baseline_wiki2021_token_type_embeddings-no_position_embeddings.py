...
from rerankGPT2LMHeadModel import rerankGPT2LMHeadModel_token_type_embeddings_no_position_embeddings, wiki2021_GPT2Dataset
...
model = rerankGPT2LMHeadModel_token_type_embeddings_no_position_embeddings.from_pretrained("gpt2", config=configuration,
                                                                                            MAX_LEN = MAX_LEN,
                                                                                            CAN_NUM = CAN_NUM, 
...
#                 "results/baseline_wiki2021/not_repeat_candidate/add_token_type_embeddings/"+str(step)
#             )
            
#             fg_eval.to_pickle(
#                 "results/baseline_wiki2021/not_repeat_candidate/add_token_type_embeddings/"+str(step)+"/fg_eval.pkl")
...
# model.module.save_pretrained("results/baseline_wiki2021/not_repeat_candidate/add_token_type_embeddings/last_model")