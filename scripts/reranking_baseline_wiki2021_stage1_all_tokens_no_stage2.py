    ...
    for step, batch in enumerate(train_dataloader):      
        ...
        if step % 20000 == 0 and not step == 0:
            ...
            model.module.save_pretrained(
                "results/baseline_wiki2021/stage1_all_tokens_no_stage2_canNUM20/"+str(step)
            )
...
model.module.save_pretrained("results/baseline_wiki2021/stage1_all_tokens_no_stage2_canNUM20/last_model")