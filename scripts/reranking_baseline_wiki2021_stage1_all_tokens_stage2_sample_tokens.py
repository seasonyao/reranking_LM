...
model = rerankGPT2LMHeadModel_stage1_all_tokens_stage2_sample_tokens.from_pretrained("gpt2", config=configuration,
                                                                                    MAX_LEN = MAX_LEN,
                                                                                    CAN_NUM = CAN_NUM, 
    ...
    for step, batch in enumerate(train_dataloader):      
        ...
        if step % 10000 == 0 and not step == 0:           
            ...
            model.module.save_pretrained(
                "results/baseline_wiki2021/stage1_all_tokens_stage2_sample_tokens_canNUM20/"+str(step)
            )
            fg_eval.to_pickle(
                "results/baseline_wiki2021/stage1_all_tokens_stage2_sample_tokens_canNUM20/"+str(step)+"/fg_eval.pkl")
...
model.module.save_pretrained("results/baseline_wiki2021/stage1_all_tokens_stage2_sample_tokens_canNUM20/last_model")