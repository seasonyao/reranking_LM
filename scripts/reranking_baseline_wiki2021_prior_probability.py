...
from rerankGPT2LMHeadModel import rerankGPT2LMHeadModel_prior_probability, wiki2021_GPT2Dataset
...
model = rerankGPT2LMHeadModel_prior_probability.from_pretrained("gpt2", config=configuration, state_dict = model_dict,
                                                                MAX_LEN = MAX_LEN,
                                                                CAN_NUM = CAN_NUM, 
