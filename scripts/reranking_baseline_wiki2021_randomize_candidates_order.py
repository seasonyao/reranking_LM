    ...
    for step, batch in enumerate(train_dataloader):      
        ...
        if step % 10000 == 0 and not step == 0:           
            ...
            model.module.save_pretrained(
                "results/baseline_wiki2021/randomize_candidates_order/"+str(step)
            )
            
            fg_eval.to_pickle(
                "results/baseline_wiki2021/randomize_candidates_order/"+str(step)+"/fg_eval.pkl")
...
model.module.save_pretrained("results/baseline_wiki2021/randomize_candidates_order/last_model")